...
public final class LogUtils {
    ...
    public static final int IS_PRODUCT = 1;
    public static final int IS_NOT_PRODUCT = 0;
    ...
    public static class Config {
        ...
        private static int     IS_PROD_VERSION    = IS_NOT_PRODUCT;     //是否为生产版本 1 为 生产版本 0 为 非生产版本
        ...
        public Config setIsProductVersion(final int IS_PROD_VERSION){
            if(IS_PROD_VERSION == IS_NOT_PRODUCT || IS_PROD_VERSION == IS_PRODUCT){
                this.IS_PROD_VERSION =IS_PROD_VERSION;
            }else{
                this.IS_PROD_VERSION = IS_PRODUCT;
            }
            return this;
        }
    ...
    public static void v(String info){
        if(Config.IS_PROD_VERSION == IS_NOT_PRODUCT){
            Log.v(TAG, info);
        }
    }
